...
class HopperBLPEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self,
                 step_count=0,
    ...
    def step(self, action):
        ...
        single_joint_action[action_joint]=action[action_joint]

        self._action_record[action_joint]=action[action_joint]
    ...
    def reset_model(self):
        ...
        self._action_record=[0.0,0.0,0.0]
        self._step_count=0
