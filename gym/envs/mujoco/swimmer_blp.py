import numpy as np
from gym.envs.mujoco import mujoco_blp4
...
class SwimmerBLPEnv(mujoco_blp4.MujocoBLPEnv, utils.EzPickle):
    def __init__(self,
                 action_record=[0.0,0.0],
        ...
        mujoco_blp4.MujocoBLPEnv.__init__(self, xml_file, 4)
